...
const LeaderboardPage = () => {
  ...
  const currentUserRank = leaderboard.find(item => item.isCurrentUser || (user && item.userId === user.id))?.rank || 3;
    ...
    <div className="page-view animate-fade-in" style={{ display: 'flex', flexDirection: 'column', gap: '1.8rem' }}>
      ...
      <div style={{
        ...
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', marginBottom: '0.6rem' }}>
            <span className="badge badge-gold">
              <Swords size={14} /> COMMUNITY DIVISION TIER #1
            </span>
            <span className="badge badge-cyan">
              <Sparkles size={14} /> LIVE STANDINGS
            </span>
          </div>
          <h1 style={{ fontSize: '2.2rem', margin: 0, fontWeight: 800, fontFamily: 'var(--font-heading)', color: '#FFFFFF' }}>
            EMERALD LEADERBOARD
          </h1>
          <p style={{ color: '#9198A1', fontSize: '1rem', marginTop: '0.4rem', maxWidth: '640px', lineHeight: 1.5 }}>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontSize: '0.78rem', color: '#9198A1', fontWeight: 700 }}>YOUR CURRENT RANK</div>
            ...
            <div style={{ fontSize: '0.85rem', color: '#38BDF8', display: 'flex', gap: '0.8rem', marginTop: '0.2rem', fontWeight: 700 }}>
              ...
              <span style={{ color: '#FB923C' }}>🔥 {streak || 1} DAY STREAK</span>
            </div>
          </div>
        </div>
      </div>
        ...
        {leagues.map((lg) => (
          <button
            ...
            style={{
              ...
              color: lg.name === activeLeague ? lg.color : '#9198A1',
              fontWeight: 800,
              fontFamily: 'var(--font-heading)',
              fontSize: '0.9rem',
              cursor: 'pointer',
          ...
          >
            ...
            {lg.current && <span style={{ fontSize: '0.65rem', backgroundColor: '#34D399', color: '#0D1117', padding: '0.15rem 0.45rem', borderRadius: '4px', fontWeight: 800 }}>ACTIVE</span>}
          </button>
        ))}
      </div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
        ...
        <div style={{ display: 'flex', gap: '0.4rem', backgroundColor: '#161B22', padding: '0.3rem', borderRadius: '10px', border: '1px solid #30363D' }}>
          {['weekly', 'today', 'alltime'].map((tf) => (
            <button
              ...
              style={{
                ...
                color: timeframe === tf ? '#0D1117' : '#9198A1',
                border: 'none',
      ...
      {leaderboard.length === 0 ? (
        <div style={{
          ...
          <Trophy size={48} color="#9198A1" style={{ opacity: 0.5 }} />
          <h3 style={{ fontSize: '1.4rem', color: '#FFFFFF', fontWeight: 800, margin: 0, fontFamily: 'var(--font-heading)' }}>
            No Rankings Available Yet
          </h3>
          <p style={{ color: '#9198A1', fontSize: '0.95rem', maxWidth: '480px', margin: 0, lineHeight: 1.5 }}>
            ...
            {topThree.map((item, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div style={{ fontSize: '0.85rem', color: '#9198A1', marginBottom: '1rem', fontWeight: 600 }}>
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        borderBottom: idx === remainingList.length - 1 ? 'none' : '1px solid #30363D',
                        backgroundColor: isUser ? 'rgba(56, 189, 248, 0.1)' : '#0D1117',
                        transition: 'all 0.2s ease'
                      }}
                    >
                      <div style={{ display: 'flex', alignItems: 'center', gap: '1.4rem' }}>
                        <span style={{ fontWeight: 800, fontFamily: 'var(--font-heading)', color: isUser ? '#38BDF8' : '#9198A1', width: '32px', fontSize: '1.05rem' }}>
                          #{rank}
                        </span>
                        ...
                        <div className="icon-box" style={{
                          ...
                          height: 42,
                          borderRadius: '10px',
                          backgroundColor: isUser ? '#38BDF8' : '#21262D',
                          color: isUser ? '#0D1117' : '#FFFFFF',
                          fontWeight: 800,
                          fontFamily: 'var(--font-heading)',
                          fontSize: '0.9rem',
                          border: '1px solid #30363D'
                        ...
                        <div>
                          ...
                          <div style={{ fontSize: '0.82rem', color: '#9198A1' }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '2rem' }}>
                        <div style={{
                          ...
                          <span>{item.currentStreak || streak || 1}d STREAK</span>
                        </div>
                        ...
                        <div style={{ textAlign: 'right', minWidth: '100px' }}>
                          ...
                          <div style={{ fontSize: '0.75rem', color: rank <= 5 ? '#34D399' : '#9198A1', fontWeight: 700 }}>
